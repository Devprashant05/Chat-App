...
const SettingsPage = () => {
    ...
    return (
        <div className="h-fit container mx-auto px-4 pt-20 pb-10 max-w-5xl">
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-3">
                    {THEMES.map((theme) => (
                        <button
                            key={theme}
                            className={`group flex flex-col items-center gap-1 p-2 rounded-lg transition-colors cursor-pointer ${
                                theme === theme
                                    ? "bg-base-200"
                            ...
                            <div className=" bg-base-100 rounded-xl shadow-sm overflow-hidden">
                                ...
                                <div className="p-4 border-t border-base-300 bg-base-100">
                                    <div className="flex gap-2">
                                        <input
                                            type="text"
                                            className="input bordered flex-1 text-sm h-10"
